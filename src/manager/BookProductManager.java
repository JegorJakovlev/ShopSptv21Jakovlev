...
public class BookProductManager {
    ...
    public Product createProduct(String productName, int quantity, int price) throws IOException {
        ...
        line.append("Количество: ").append(String.valueOf(product.getQuantity())).append(" - ");
    ...
    public void ProductChange(Product[] products) {
        ...
        System.out.println("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
        System.out.print("Выберите номер продукта для изменения: ");
        ...
        System.out.print("Изменить название продукта ? (yes/no)");
        ...
        System.out.print("Изменить цену продукта? (yes/no)");
        ...
        System.out.print("Изменить количество данного товара на складе? (yes/no)");
        edit = scanner.nextLine();
        if (edit.equals("yes")) {
            System.out.print("Введите другое количество продуктов: ");
